  ...
  <div class="about">
    ...
    <div class="about-content" style="grid-template-columns: 3fr 2fr">
      ...
      <div class="about-item hello">
        ...
        <span class="text2 title2">我是 v123ve</span>
    ...
    <div class="about-content" style="grid-template-columns: 3fr 2fr">
      ...
      <div class="about-item character" style="--color: #4298b4">
        ...
        <span class="title2">守护者</span>
        <span class="title2" style="color: var(--color)">ISFJ-A / ISFJ-T</span>
        <span class="more">
          在
      ...
      <div class="about-item">
        ...
        <span class="title1" style="margin-top: 20px">心如花木，</span>
        <span class="title2">向阳而生。</span>
      </div>
    </div>
    <div class="about-content" style="grid-template-columns: 1fr 1fr">
      ...
      >
        <div class="image-content">
          ...
          <span class="title2">AI、科技、游戏</span>
          <div class="image-desc">
            <span class="left">啥都懂等于啥都不懂</span>
          </div>
        </div>
      </div>
      <div
      ...
      >
        <div class="image-content">
          ...
          <span class="title2">中国风、戏腔、纯音乐、非主流</span>
          <div class="image-desc">
